...
@section('content')
<a class="btn btn-primary" href="{{route('preguntas.create') }}">Crear Nuevo</a>
...
<table id="divionest" class="table">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>
                <a  class="btn btn-warning "  href="{{route('preguntas.edit', $pregunta->id)}}">Editar</a>
                <form method="POST" action="{{ route('preguntas.destroy', $pregunta->id) }}" style="display:inline">
                    @csrf
                    @method('DELETE')
